...
**Streaming behavior:** Unterminated code blocks are gracefully handled by remend. Copy/download buttons disabled when
`isAnimating={true}`.

**Common issue — Shiki external package warning:** If using Next.js and seeing warnings, install shiki explicitly and
