...
export function CompassLink() {
  return (
    ...
    >
      ...
      />
      <span className="absolute left-1/2 -translate-x-1/2 -bottom-6 text-[10px] tracking-[0.3em] whitespace-nowrap font-serif pointer-events-none transition-colors duration-300">
