...
export function setupWorld(provider: DojoProvider) {
	...
	const actions_1v1_createMatch1V1 = async (snAccount: Account | AccountInterface, playerA: string, playerB: string) => {
		try {
	...
	const actions_1v1_setAbilityToken = async (snAccount: Account | AccountInterface, abilityToken: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_actions_1v1_setAbilityToken_calldata(abilityToken),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_actions_1v1_setResourceConfig_calldata = (iron: string, linen: string, stone: string, wood: string, ember: string, seeds: string): DojoCall => {
		return {
			contractName: "actions_1v1",
	...
	const actions_1v1_setResourceConfig = async (snAccount: Account | AccountInterface, iron: string, linen: string, stone: string, wood: string, ember: string, seeds: string) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const actions_1v1_setVrfProvider = async (snAccount: Account | AccountInterface, vrfProvider: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_actions_1v1_setVrfProvider_calldata(vrfProvider),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_actions_createMatch_calldata = (teamAAttacker: string, teamADefender: string, teamBAttacker: string, teamBDefender: string): DojoCall => {
		return {
	...
	const actions_createMatch = async (snAccount: Account | AccountInterface, teamAAttacker: string, teamADefender: string, teamBAttacker: string, teamBDefender: string) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const commit_reveal_1v1_commit = async (snAccount: Account | AccountInterface, matchId: BigNumberish, commitment: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const commit_reveal_1v1_forceTimeout = async (snAccount: Account | AccountInterface, matchId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_commit_reveal_1v1_forceTimeout_calldata(matchId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_commit_reveal_1v1_reveal_calldata = (matchId: BigNumberish, salt: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, repair: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish, trap0: BigNumberish, trap1: BigNumberish, trap2: BigNumberish, abilityId: BigNumberish, abilityTarget: BigNumberish): DojoCall => {
		return {
			contractName: "commit_reveal_1v1",
			entrypoint: "reveal",
	...
	const commit_reveal_1v1_reveal = async (snAccount: Account | AccountInterface, matchId: BigNumberish, salt: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, repair: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish, trap0: BigNumberish, trap1: BigNumberish, trap2: BigNumberish, abilityId: BigNumberish, abilityTarget: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_commit_reveal_1v1_reveal_calldata(matchId, salt, p0, p1, p2, g0, g1, g2, repair, nc0, nc1, nc2, trap0, trap1, trap2, abilityId, abilityTarget),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const commit_reveal_commit = async (snAccount: Account | AccountInterface, matchId: BigNumberish, commitment: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_commit_reveal_commit_calldata(matchId, commitment),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const commit_reveal_forceTimeout = async (snAccount: Account | AccountInterface, matchId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_commit_reveal_forceTimeout_calldata(matchId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_commit_reveal_revealAttacker_calldata = (matchId: BigNumberish, salt: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish): DojoCall => {
		return {
			contractName: "commit_reveal",
	...
	const commit_reveal_revealAttacker = async (snAccount: Account | AccountInterface, matchId: BigNumberish, salt: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_commit_reveal_revealDefender_calldata = (matchId: BigNumberish, salt: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, repair: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish): DojoCall => {
		return {
			contractName: "commit_reveal",
	...
	const commit_reveal_revealDefender = async (snAccount: Account | AccountInterface, matchId: BigNumberish, salt: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, repair: BigNumberish, nc0: BigNumberish, nc1: BigNumberish, nc2: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_conquest_initiateConquest_calldata = (targetParcel: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, abilityId: BigNumberish, abilityTarget: BigNumberish): DojoCall => {
		return {
	...
	const conquest_initiateConquest = async (snAccount: Account | AccountInterface, targetParcel: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish, abilityId: BigNumberish, abilityTarget: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_conquest_setPresetDefense_calldata = (index: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish): DojoCall => {
		return {
			contractName: "conquest",
	...
	const conquest_setPresetDefense = async (snAccount: Account | AccountInterface, index: BigNumberish, p0: BigNumberish, p1: BigNumberish, p2: BigNumberish, g0: BigNumberish, g1: BigNumberish, g2: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const crafting_1v1_craftAbility = async (snAccount: Account | AccountInterface, abilityId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_crafting_1v1_craftAbility_calldata(abilityId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const resolution_1v1_resolveRound = async (snAccount: Account | AccountInterface, matchId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_resolution_1v1_resolveRound_calldata(matchId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const resolution_resolveRound = async (snAccount: Account | AccountInterface, matchId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_resolution_resolveRound_calldata(matchId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_acceptInvite = async (snAccount: Account | AccountInterface, factionId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_acceptInvite_calldata(factionId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_claimDrip = async (snAccount: Account | AccountInterface) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_claimDrip_calldata(),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_claimParcel = async (snAccount: Account | AccountInterface, matchId: BigNumberish, parcelId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const world_system_createFaction = async (snAccount: Account | AccountInterface, name: BigNumberish, tag: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_createFaction_calldata(name, tag),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_world_system_createStakedMatch_calldata = (opponent: string, abilities: Array<BigNumberish>): DojoCall => {
		return {
			contractName: "world_system",
	...
	const world_system_createStakedMatch = async (snAccount: Account | AccountInterface, opponent: string, abilities: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const build_world_system_initializeWorld_calldata = (cols: Array<BigNumberish>, rows: Array<BigNumberish>, types: Array<BigNumberish>): DojoCall => {
		return {
			contractName: "world_system",
	...
	const world_system_initializeWorld = async (snAccount: Account | AccountInterface, cols: Array<BigNumberish>, rows: Array<BigNumberish>, types: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const world_system_initiatePillage = async (snAccount: Account | AccountInterface, matchId: BigNumberish, homeParcelId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const world_system_inviteMember = async (snAccount: Account | AccountInterface, target: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_inviteMember_calldata(target),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_world_system_joinStakedMatch_calldata = (matchId: BigNumberish, abilities: Array<BigNumberish>): DojoCall => {
		return {
			contractName: "world_system",
	...
	const world_system_joinStakedMatch = async (snAccount: Account | AccountInterface, matchId: BigNumberish, abilities: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
	...
	const world_system_kickMember = async (snAccount: Account | AccountInterface, target: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_kickMember_calldata(target),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_leaveFaction = async (snAccount: Account | AccountInterface) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_leaveFaction_calldata(),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const build_world_system_onErc1155BatchReceived_calldata = (operator: string, from: string, tokenIds: Array<BigNumberish>, values: Array<BigNumberish>, data: Array<BigNumberish>): DojoCall => {
		return {
			contractName: "world_system",
	...
	const world_system_onErc1155BatchReceived = async (operator: string, from: string, tokenIds: Array<BigNumberish>, values: Array<BigNumberish>, data: Array<BigNumberish>) => {
		try {
			return await provider.call("siege_dojo", build_world_system_onErc1155BatchReceived_calldata(operator, from, tokenIds, values, data));
		} catch (error) {
			console.error(error);
			throw error;
		}
	...
	const build_world_system_onErc1155Received_calldata = (operator: string, from: string, tokenId: BigNumberish, value: BigNumberish, data: Array<BigNumberish>): DojoCall => {
		return {
			contractName: "world_system",
	...
	const world_system_onErc1155Received = async (operator: string, from: string, tokenId: BigNumberish, value: BigNumberish, data: Array<BigNumberish>) => {
		try {
			return await provider.call("siege_dojo", build_world_system_onErc1155Received_calldata(operator, from, tokenId, value, data));
		} catch (error) {
			console.error(error);
			throw error;
		}
	...
	const world_system_registerPlayer = async (snAccount: Account | AccountInterface, homeTypes: Array<BigNumberish>) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_registerPlayer_calldata(homeTypes),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_setAbilityToken = async (snAccount: Account | AccountInterface, abilityToken: string) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_setAbilityToken_calldata(abilityToken),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_settleMatch = async (snAccount: Account | AccountInterface, matchId: BigNumberish) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_settleMatch_calldata(matchId),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
	...
	const world_system_upgradeKingdom = async (snAccount: Account | AccountInterface) => {
		try {
			return await provider.execute(
				snAccount,
				build_world_system_upgradeKingdom_calldata(),
				"siege_dojo",
			);
		} catch (error) {
			console.error(error);
